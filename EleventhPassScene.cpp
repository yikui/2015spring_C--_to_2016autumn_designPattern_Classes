...
bool EleventhPass::init()
{
	...
	Sprite* up_platform1, *down_platform1;
	sbuilder->setBrick(up_platform1, "chapter11\\11upsquare1.png", 185, 345);
	sbuilder->setBrickPhysics(up_platform1, true, 1.0f, 1.0f, 0.0f, 0, 0,  6);
	addChild(up_platform1);
	sbuilder->setBrick(down_platform1, "chapter11\\11upsquare1.png", 185, 295);
	sbuilder->setBrickPhysics(down_platform1, true, 1.0f, 1.0f, 0.0f, 0, 0, 6);
	...
	*/
	Sprite* up_platform3, *down_platform3;
	sbuilder->setBrick(up_platform3, "chapter11\\11upsquare1.png", 775, 345);
	sbuilder->setBrickPhysics(up_platform3, true, 1.0f, 1.0f, 0.0f, 0, 0, 6);
	addChild(up_platform3);
	sbuilder->setBrick(down_platform3, "chapter11\\11upsquare1.png", 745, 375);
	sbuilder->setBrickPhysics(down_platform3, true, 1.0f, 1.0f, 0.0f, 0, 0, 6);
	addChild(down_platform3);
	/*
	...
	*/
	Sprite* up_platform4, *down_platform4;
	sbuilder->setBrick(up_platform4, "chapter11\\11upsquare3.png", 745, 375);
	sbuilder->setBrickPhysics(up_platform4, true, 1.0f, 1.0f, 0.0f, 0, 0, 6);
	addChild(up_platform4);
	sbuilder->setBrick(down_platform4, "chapter11\\11upsquare3.png", 745, 265);
	sbuilder->setBrickPhysics(down_platform4, true, 1.0f, 1.0f, 0.0f, 0, 0, 6);
	addChild(down_platform4);
	/*
	...
	*/
	...
	sbuilder->setBrick(up_brick1, "chapter11\\11downsquare2.png", 270, 405);
	sbuilder->setBrickPhysics(up_brick1, true, 1.0f, 1.0f, 0.0f, 0, 0, 6);
	addChild(up_brick1);
	sbuilder->setBrick(down_brick1, "chapter11\\11downsquare2.png", 270, 235);
	sbuilder->setBrickPhysics(down_brick1, true, 1.0f, 1.0f, 0.0f, 0, 0, 6);
	...
	*/
	...
	sbuilder->setBrick(up_brick2, "chapter11\\11upsquare1.png", 310, 405);
	sbuilder->setBrickPhysics(up_brick2, true, 1.0f, 1.0f, 0.0f, 0, 0, 6);
	addChild(up_brick2);
	sbuilder->setBrick(down_brick2, "chapter11\\11upsquare1.png", 315, 235);
	sbuilder->setBrickPhysics(down_brick2, true, 1.0f, 1.0f, 0.0f, 0, 0, 6);
	...
	*/
	...
	sbuilder->setBrick(up_brick3, "chapter11\\11downsquare2.png", 360, 405);
	sbuilder->setBrickPhysics(up_brick3, true, 1.0f, 1.0f, 0.0f, 0, 0, 6);
	addChild(up_brick3);
	sbuilder->setBrick(down_brick3, "chapter11\\11downsquare2.png", 360, 235);
	sbuilder->setBrickPhysics(down_brick3, true, 1.0f, 1.0f, 0.0f, 0, 0, 6);
	...
	*/
	Sprite* up_brick4, *down_brick4;
	sbuilder->setBrick(up_brick4, "chapter11\\11upsquare2.png", 430, 435);
	sbuilder->setBrickPhysics(up_brick4, true, 1.0f, 1.0f, 0.0f, 0, 0, 6);
	addChild(up_brick4);
	sbuilder->setBrick(down_brick4, "chapter11\\11upsquare2.png", 430, 205);
	sbuilder->setBrickPhysics(down_brick4, true, 1.0f, 1.0f, 0.0f, 0, 0, 6);
	...
	*/
	Sprite* up_brick5, *down_brick5;
	sbuilder->setBrick(up_brick5, "chapter11\\11upsquare1.png", 445, 465);
	sbuilder->setBrickPhysics(up_brick5, true, 1.0f, 1.0f, 0.0f, 0, 0, 6);
	addChild(up_brick5);
	sbuilder->setBrick(down_brick5, "chapter11\\11upsquare1.png", 445, 175);
	sbuilder->setBrickPhysics(down_brick5, true, 1.0f, 1.0f, 0.0f, 0, 0, 6);
	...
	*/
	Sprite* up_brick6, *down_brick6;
	sbuilder->setBrick(up_brick6, "chapter11\\11upsquare2.png", 490, 435);
	sbuilder->setBrickPhysics(up_brick6, true, 1.0f, 1.0f, 0.0f, 0, 0, 6);
	addChild(up_brick6);
	sbuilder->setBrick(down_brick6, "chapter11\\11upsquare2.png", 490, 205);
	sbuilder->setBrickPhysics(down_brick6, true, 1.0f, 1.0f, 0.0f, 0, 0, 6);
	...
	*/
	Sprite* up_brick7, *down_brick7;
	sbuilder->setBrick(up_brick7, "chapter11\\11downsquare1.png", 475, 465);
	sbuilder->setBrickPhysics(up_brick7, true, 1.0f, 1.0f, 0.0f, 0, 0, 6);
	addChild(up_brick7);
	sbuilder->setBrick(down_brick7, "chapter11\\11downsquare1.png", 475, 175);
	sbuilder->setBrickPhysics(down_brick7, true, 1.0f, 1.0f, 0.0f, 0, 0, 6);
	...
	*/
	Sprite* up_brick8, *down_brick8;
	sbuilder->setBrick(up_brick8, "chapter11\\11upsquare2.png", 570, 435);
	sbuilder->setBrickPhysics(up_brick8, true, 1.0f, 1.0f, 0.0f, 0, 0, 6);
	addChild(up_brick8);
	sbuilder->setBrick(down_brick8, "chapter11\\11upsquare2.png", 570, 205);
	sbuilder->setBrickPhysics(down_brick8, true, 1.0f, 1.0f, 0.0f, 0, 0, 6);
	...
	*/
	Sprite* up_brick9, *down_brick9;
	sbuilder->setBrick(up_brick9, "chapter11\\11upsquare1.png", 615, 405);
	sbuilder->setBrickPhysics(up_brick9, true, 1.0f, 1.0f, 0.0f, 0, 0, 6);
	addChild(up_brick9);
	sbuilder->setBrick(down_brick9, "chapter11\\11upsquare1.png", 615, 235);
	sbuilder->setBrickPhysics(down_brick9, true, 1.0f, 1.0f, 0.0f, 0, 0, 6);
	...
	*/
	Sprite* up_brick10, *down_brick10;
	sbuilder->setBrick(up_brick10, "chapter11\\11downsquare1.png", 645, 405);
	sbuilder->setBrickPhysics(up_brick10, true, 1.0f, 1.0f, 0.0f, 0, 0, 6);
	addChild(up_brick10);
	sbuilder->setBrick(down_brick10, "chapter11\\11downsquare1.png", 645, 235);
	sbuilder->setBrickPhysics(down_brick10, true, 1.0f, 1.0f, 0.0f, 0, 0, 6);
	addChild(down_brick10);
	/*
	...
	*/
	Sprite* up_brick11, *down_brick11;
	sbuilder->setBrick(up_brick11, "chapter11\\11upsquare2.png", 690, 405);
	sbuilder->setBrickPhysics(up_brick11, true, 1.0f, 1.0f, 0.0f, 0, 0, 6);
	addChild(up_brick11);
	sbuilder->setBrick(down_brick11, "chapter11\\11upsquare2.png", 690, 235);
	sbuilder->setBrickPhysics(down_brick11, true, 1.0f, 1.0f, 0.0f, 0, 0, 6);
	addChild(down_brick11);
	/*
	...
	*/
	string thorn_img[] = { "chapter11\\11upthorn1.png", "chapter11\\11downthorn1.png" };
	float x = 242.5, y = 334, increase = 50;
	for (int i = 0; i < 14; ++i)
	{
		Sprite* thorn;
		if (i < 10) {
			sbuilder->setThorn(thorn, thorn_img[0], x + increase * i, y);
			sbuilder->setThornPhysics(thorn, true, 1.0f, 0.4f, 0.0f, 0, 0, 2);
		}
		else if (i == 10){
			sbuilder->setThorn(thorn, thorn_img[1], 645, 424);
			sbuilder->setThornPhysics(thorn, true, 1.0f, 1.0f, 0.0f, 0, 0, 2);
		}
		else if (i == 11){
			sbuilder->setThorn(thorn, thorn_img[1], 645, 216);
			sbuilder->setThornPhysics(thorn, true, 1.0f, 1.0f, 0.0f, 0, 0, 2);
		}
		else if (i == 12){
			sbuilder->setThorn(thorn, thorn_img[0], 315, 424);
			sbuilder->setThornPhysics(thorn, true, 1.0f, 1.0f, 0.0f, 0, 0, 2);
		}
		else {
			sbuilder->setThorn(thorn, thorn_img[0], 315, 216);
			sbuilder->setThornPhysics(thorn, true, 1.0f, 1.0f, 0.0f, 0, 0, 2);
		}
		addChild(thorn);
		thorn_vec.push_back(thorn);
	}
	/*
