...
bool FifthPass::init()
{
	...
	sbuilder->setBrick(up_brick1, "chapter5\\downbrick.png", 180, visibleSize.height / 2 + 40);
	sbuilder->setBrickPhysics(up_brick1, true, 1.0f, 0.4f, 0.0f, 0, 0, 6);
	sbuilder->setBrick(down_brick1, "chapter5\\downbrick.png", 180, visibleSize.height / 2 - 40);
	sbuilder->setBrickPhysics(down_brick1, true, 1.0f, 0.4f, 0.0f, 0, 0, 6);
	addChild(up_brick1);
	...
	*/
	...
	sbuilder->setBrick(up_brick2, "chapter5\\up_brick2.png", 276, visibleSize.height / 2 + 50);
	sbuilder->setBrickPhysics(up_brick2, true,1.0f, 0.4f, 0.0f, 0, 0, 6);
	sbuilder->setBrick(down_brick2, "chapter5\\down_brick2.png", 276, visibleSize.height / 2 - 50);
	...
	*/
	...
	sbuilder->setBrick(up_brick3, "chapter5\\down_brick3.png", 300, visibleSize.height / 2 + 120);
	sbuilder->setBrickPhysics(up_brick3, true, 1.0f, 0.4f, 0.0f, 0, 0, 6);
	sbuilder->setBrick(down_brick3, "chapter5\\down_brick3.png", 300, visibleSize.height / 2 - 120);
	...
	*/
	...
	sbuilder->setBrick(up_brick4, "chapter5\\up_brick4.png", 376, visibleSize.height / 2 + 90);
	sbuilder->setBrickPhysics(up_brick4,  true, 1.0f, 0.4f, 0.0f, 0, 0, 6);
	sbuilder->setBrick(down_brick4, "chapter5\\down_brick4.png", 376, visibleSize.height / 2 - 90);
	sbuilder->setBrickPhysics(down_brick4, true, 1.0f, 0.4f, 0.0f, 0, 0, 6);
	addChild(up_brick4);
	...
	*/
	Sprite* up_thorn, *down_thorn;
	sbuilder->setThorn(up_thorn, "chapter5\\4up_thorn.png", 566, visibleSize.height / 2 + 14);
	sbuilder->setThornPhysics(up_thorn, true, 0, 0, 0, 0, 0, 2);
	sbuilder->setThorn(down_thorn, "chapter5\\4down_thorn.png", 566, visibleSize.height / 2 - 14);
	sbuilder->setThornPhysics(down_thorn, true, 0, 0, 0, 0, 0, 2);
	addChild(up_thorn);
	addChild(down_thorn);
	/*
	...
	*/
	...
	sbuilder->setBrick(up_brick5, "chapter5\\downbrick.png", 566, visibleSize.height / 2 + 100);
	sbuilder->setBrickPhysics(up_brick5, true, 1.0f, 0.4f, 0.0f, 0, 0, 6);
	sbuilder->setBrick(down_brick5, "chapter5\\downbrick.png", 566, visibleSize.height / 2 - 100);
	sbuilder->setBrickPhysics(down_brick5, true, 1.0f, 0.4f, 0.0f, 0, 0, 6);
	addChild(up_brick5);
	...
	*/
	...
	sbuilder->setThorn(down_thorn_move, "chapter5\\down_thorn_move.png", 320, visibleSize.height / 2 - 94);
	sbuilder->setThornPhysics(down_thorn_move, true, 0, 0, 0, 0, 0, 2);
