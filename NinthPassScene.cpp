...
bool NinthPass::init()
{
	...
	sbuilder->setBrick(up_platform1, "chapter9\\9upplatform1.png", 110, 345);
	sbuilder->setBrickPhysics(up_platform1, true, 0, 0, 0, 0, 0, 6);
	addChild(up_platform1);

	sbuilder->setBrick(down_platform1, "chapter9\\9downplatform1.png", 110, 295);
	sbuilder->setBrickPhysics(down_platform1, true, 0, 0, 0, 0, 0, 6);
	...
	*/
	Sprite* up_platform2, *down_platform2;
	sbuilder->setBrick(up_platform2, "chapter9\\9upplatform2.png", 335, 345);
	sbuilder->setBrickPhysics(up_platform2, true, 0, 0, 0, 0, 0, 6);
	addChild(up_platform2);

	sbuilder->setBrick(down_platform2, "chapter9\\9downplatform2.png", 335, 295);
	sbuilder->setBrickPhysics(down_platform2, true, 0, 0, 0, 0, 0, 6);
	addChild(down_platform2);
	/*
	...
	*/
	...
	sbuilder->setBrick(up_platform3, "chapter9\\9upplatform3.png", 590, 345);
	sbuilder->setBrickPhysics(up_platform3, true, 0, 0, 0, 0, 0, 6);
	addChild(up_platform3);

	sbuilder->setBrick(down_platform3, "chapter9\\9downplatform3.png", 590, 295);
	sbuilder->setBrickPhysics(down_platform3, true, 0, 0, 0, 0, 0, 6);
	...
	*/
	...
	sbuilder->setThorn(up_thorn1, "chapter9\\9downthorn1.png", 340, 364);
	sbuilder->setThornPhysics(up_thorn1, true, 0, 0, 0, 0, 0, 2);
	addChild(up_thorn1);

	sbuilder->setThorn(down_thorn1, "chapter9\\9downthorn1.png", 340, 276);
	...
	*/
	...
	sbuilder->setThorn(up_thorn2, "chapter9\\9upthorn2.png",  775, 334);
	sbuilder->setThornPhysics(up_thorn2, true, 0, 0, 0, 0, 0, 2);
	addChild(up_thorn2);

	sbuilder->setThorn(down_thorn2, "chapter9\\9downthorn2.png",  775, 276);
	...
	*/
	...
	sbuilder->setBrick(up_brick1, "chapter9\\9upbrick1.png", 695, 374);
	sbuilder->setBrickPhysics(up_brick1, false, 1000000.0f, 0.4f, 0.0f, 50, 0, 1);
	addChild(up_brick1);

	sbuilder->setBrick(down_brick1, "chapter9\\9upbrick1.png", 695, 266);
	sbuilder->setBrickPhysics(down_brick1, false, 1000000.0f, 0.4f, 0.0f, 50, 0, 1);
	addChild(down_brick1);

	upBrickBody = up_brick1->getPhysicsBody();
	downBrickBody = down_brick1->getPhysicsBody();
	/*
	...
	*/
	...
	sbuilder->setThorn(up_thorn3, "chapter9\\9downthorn1.png", 590, 364);
	sbuilder->setThornPhysics(up_thorn3, true, 0, 0, 0, 0, 0, 2);
	addChild(up_thorn3);

	sbuilder->setThorn(down_thorn3, "chapter9\\9downthorn1.png", 590, 276);
	...
	*/
	Sprite* up_thorn4, *down_thorn4;
	sbuilder->setThorn(up_thorn4, "chapter9\\9downthorn1.png", 180, 335);
	sbuilder->setThornPhysics(up_thorn4, false, 0, 0, 0, 0, 0, 2);
	addChild(up_thorn4);

	sbuilder->setThorn(down_thorn4, "chapter9\\9downthorn1.png", 180, 303);
	sbuilder->setThornPhysics(down_thorn4, false, 0, 0, 0, 0, 0, 2);
	addChild(down_thorn4);

	upThornBody4 = up_thorn4->getPhysicsBody();
	downThornBody4 = down_thorn4->getPhysicsBody();
	/*
	...
	*/
	...
	sbuilder->setThorn(up_thorn5, "chapter9\\9downthorn1.png", 420, 335);
	sbuilder->setThornPhysics(up_thorn5, false, 0, 0, 0, 0, 0, 2);
	addChild(up_thorn5);

	sbuilder->setThorn(down_thorn5, "chapter9\\9downthorn1.png", 420, 303);
	sbuilder->setThornPhysics(down_thorn5, false, 0, 0, 0, 0, 0, 2);
	addChild(down_thorn5);

	upThornBody5 = up_thorn5->getPhysicsBody();
	downThornBody5 = down_thorn5->getPhysicsBody();
	/*
